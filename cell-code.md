...
as an argument to the ``string`` call; see [error.jl](https://github.com/JuliaLang/julia/blob/master/base/error.jl) for
...
[卫生宏](http://en.wikipedia.org/wiki/Hygienic_macro)是个更复杂的宏。In short, macros must
